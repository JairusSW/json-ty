...
describe("Should treat @json typed-array subclasses as generated classes with inherited stdlib fields", () => {
  ...
  // JavaScript exposes byteOffset where AssemblyScript exposes dataStart.
  expect(encoded.includes('"byteOffset":0')).toBe(true);
