...
describe("Should resolve imported schemas", () => {
  expect(JSON.stringify(player)).toBe(
    '{"first name":"Jairus","lastName":"Tanaka","lastActive":[3,9,2025],"age":18,"pos":{"x":3.4,"y":1.2,"z":8.3},"isVerified":true}',
  );
});
...
describe("Should resolve imported schemas inside arrays", () => {
  const parsed = JSON.parse<Team>(
    '{"players":[{"first name":"Jairus","lastName":"Tanaka","lastActive":[3,9,2025],"age":18,"pos":{"x":3.4,"y":1.2,"z":8.3},"isVerified":true},{"first name":"A","lastName":"B","lastActive":[1,2,3],"age":19,"pos":null,"isVerified":false}]}',
  );
